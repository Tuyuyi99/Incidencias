...
class Controlador
{
    ...
    private $vista, $usuarios, $incidencias;
	...
	public function __construct(){
		...
		$this->incidencias = new Incidencia();
    }
	...
	public function procesarIncidencia(){
	...
	public function showModificarIncidencias(){
		if (isset($_SESSION["idUsuario"])) {
			$idIncidencia = $_REQUEST["idIncidencia"];
	...
	public function showListaIncidencias(){
